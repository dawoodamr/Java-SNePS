...
public class cmdFindAssert extends javax.swing.JPanel {
	private JLabel findAssertLabel;
	...
	private void initGUI() {
		try {
			...
			this.setLayout(null);
			{
				findAssertLabel = new JLabel();
				this.add(findAssertLabel);
				findAssertLabel.setName("findAssertLabel");
				findAssertLabel.setBounds(5, 28, 80, 15);
			}
			{
			...
			}
			{
				...
				jScrollPane2.setBounds(85, 60, 213, 103);
				{
					...
					pathList.setBounds(89, 99, 228, 102);
					pathList.setPreferredSize(new java.awt.Dimension(192, 81));
				}
			}
			{
