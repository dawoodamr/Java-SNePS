...
public class cmdSNSequence extends javax.swing.JPanel {
	...
	private JLabel buildActionSNSequenceLabel;
	...
	private void initGUI() {
		try {
			...
			{
				buildActionSNSequenceLabel = new JLabel();
				this.add(buildActionSNSequenceLabel);
				buildActionSNSequenceLabel.setBounds(71, 12, 155, 15);
				buildActionSNSequenceLabel.setName("buildActionSNSequenceLabel");
			}
			{
			...
			}
			{
				...
				objectButton.setBounds(611, 150, 57, 22);
	...
	private void objectButtonActionPerformed(ActionEvent evt) {
		JFrame popupFrame = new JFrame("Object");
		popupFrame.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
		popupFrame.getContentPane().add(new cmdObject(network, frame));
		popupFrame.pack();
		popupFrame.setVisible(true);
	}
}
