...
public class cmdWithSome extends javax.swing.JPanel {
	...
	public cmdWithSome(Network network, SNePSInterface frame, JFrame windowFrame) {
		super();
		this.frame = frame;
		this.network = network;
		...
		try {
			...
			}
			{
				...
				jScrollPane1.setBounds(80, 58, 440, 103);
				{
					...
					actionData.add("withsome");
					relationNodesetTableModel.addRow(actionData);
					
					Vector<Object> varData = new Vector<Object>();
					varData.add("var");
					varData.add("");
					varData.add("Choose Node Type");
					relationNodesetTableModel.addRow(varData);
					
					Vector<Object> suchthatData = new Vector<Object>();
					suchthatData.add("suchthat");
					suchthatData.add("");
					suchthatData.add("Choose Node Type");
					relationNodesetTableModel.addRow(suchthatData);
					
					Vector<Object> elseData = new Vector<Object>();
					elseData.add("else");
					elseData.add("");
					elseData.add("Choose Node Type");
					relationNodesetTableModel.addRow(elseData);
				}
			}
			{
