	...
	private void initGUI() {
		try {
			...
			this.setLayout(null);
			{
				...
				addToContextLabel.setBounds(12, 28, 106, 15);
			}
			{
				contextNameTextField = new JTextField();
				this.add(contextNameTextField);
				contextNameTextField.setBounds(466, 61, 184, 22);
				contextNameTextField.setEditable(false);
			}
			{
				addButton = new JButton();
				this.add(addButton);
				addButton.setBounds(313, 27, 16, 18);
			...
			}
			{
				...
				nodesetTextField.setBounds(118, 25, 189, 22);
			}
			{
			...
			}
			{
				...
				contextNameLabel.setBounds(441, 4, 97, 15);
				contextNameLabel.setName("contextNameLabel");
			}
			{
				jScrollPane2 = new JScrollPane();
				this.add(jScrollPane2);
				jScrollPane2.setBounds(118, 62, 189, 103);
				{
					...
					nodesetList.setBounds(99, 145, 186, 100);
				}
			}
			{
			...
			}
			{
				...
				contextNameRadioButton1.setBounds(441, 26, 97, 19);
			...
			}
			{
				...
				contextNameRadioButton2.setBounds(441, 66, 25, 17);
			}
			{
			...
			}
			{
				...
				buildButton.setBounds(334, 25, 18, 20);
			...
			}
			{
				...
				assertButton.setBounds(357, 25, 18, 20);
			...
			}
			{
				...
				this.add(findButton);
				findButton.setBounds(380, 25, 18, 20);
