 ...
 */
public class cmdSnif extends javax.swing.JPanel {
	...
	private JLabel buildActionDoOneLabel;
	...
	public cmdSnif(Network network) {
		super();
	...
	private void initGUI() {
		try {
			...
			}
			{
				...
				nodesetLabel.setBounds(407, 30, 66, 15);
			...
			{
				buildActionDoOneLabel = new JLabel();
				this.add(buildActionDoOneLabel);
				buildActionDoOneLabel.setBounds(71, 12, 133, 15);
				buildActionDoOneLabel.setName("buildActionDoOneLabel");
			}
			{
