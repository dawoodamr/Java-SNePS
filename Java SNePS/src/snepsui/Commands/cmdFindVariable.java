...
public class cmdFindVariable extends javax.swing.JPanel {
	private JLabel findVariableLabel;
	...
	private void initGUI() {
		try {
			...
			this.setLayout(null);
			{
				findVariableLabel = new JLabel();
				this.add(findVariableLabel);
				findVariableLabel.setName("findVariableLabel");
				findVariableLabel.setBounds(0, 28, 84, 15);
			}
			{
			...
			}
			{
				...
				jScrollPane2.setBounds(84, 60, 214, 103);
				{
					pathModel = new DefaultListModel();
					pathList = new JList();
					jScrollPane2.setViewportView(pathList);
					pathList.setModel(pathModel);
					pathList.setBounds(-6, 141, 228, 102);
					pathList.setPreferredSize(new java.awt.Dimension(203, 86));
				}
			}
			{
