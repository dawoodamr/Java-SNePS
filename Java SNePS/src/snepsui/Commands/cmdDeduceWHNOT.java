 ...
 */
public class cmdDeduceWHNOT extends javax.swing.JPanel {
	private JLabel deduceWHNOTLabel;
	...
	public cmdDeduceWHNOT(Network network, SNePSInterface frame) {
		super();
		this.frame = frame;
	...
	private void initGUI() {
		try {
			...
			this.setLayout(null);
			{
				deduceWHNOTLabel = new JLabel();
				this.add(deduceWHNOTLabel);
				deduceWHNOTLabel.setName("deduceWHNOTLabel");
				deduceWHNOTLabel.setBounds(0, 28, 80, 15);
			}
			{
