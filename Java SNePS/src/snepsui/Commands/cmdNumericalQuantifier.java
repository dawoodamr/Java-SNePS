		...
		try {
			...
			}
			{
				...
				jScrollPane1.setBounds(80, 58, 440, 103);
				{
					...
					Vector<Object> eminData = new Vector<Object>();
					eminData.add("emin");
					eminData.add("");
					eminData.add("Choose Node Type");
					relationNodesetTableModel.addRow(eminData);
					
					Vector<Object> emaxData = new Vector<Object>();
					emaxData.add("emax");
					emaxData.add("");
					emaxData.add("Choose Node Type");
					relationNodesetTableModel.addRow(emaxData);
					
					Vector<Object> etotData = new Vector<Object>();
					etotData.add("etot");
					etotData.add("");
					etotData.add("Choose Node Type");
					relationNodesetTableModel.addRow(etotData);
					
					Vector<Object> pevbData = new Vector<Object>();
					pevbData.add("pevb");
					pevbData.add("");
					pevbData.add("Choose Node Type");
					relationNodesetTableModel.addRow(pevbData);
