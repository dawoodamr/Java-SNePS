...
public class cmdFindBase extends javax.swing.JPanel {
	...
	private void initGUI() {
		try {
			...
			this.setLayout(null);
			{
				findBaseLabel = new JLabel();
				this.add(findBaseLabel);
				findBaseLabel.setName("findBaseLabel");
				findBaseLabel.setBounds(6, 28, 67, 15);
			}
			{
			...
			}
			{
				...
				jScrollPane2.setBounds(85, 60, 213, 105);
				{
					...
					pathList.setBounds(38, 171, 228, 102);
