...
public class cmdDeduceTrue extends javax.swing.JPanel {
	private JLabel deduceTrueLabel;
	...
	public cmdDeduceTrue(Network network, SNePSInterface frame) {
		super();
		this.frame = frame;
	...
	private void initGUI() {
		try {
			...
			this.setLayout(null);
			{
				deduceTrueLabel = new JLabel();
				this.add(deduceTrueLabel);
				deduceTrueLabel.setName("deduceTrueLabel");
				deduceTrueLabel.setBounds(0, 28, 80, 15);
			}
			{
