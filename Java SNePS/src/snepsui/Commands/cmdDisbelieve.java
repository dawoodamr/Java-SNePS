 ...
 */
public class cmdDisbelieve extends javax.swing.JPanel {
	...
	private JLabel buildActionDisbelieveLabel;
	...
	public cmdDisbelieve(Network network, SNePSInterface frame) {
		super();
		this.frame = frame;
	...
	private void initGUI() {
		try {
			...
			this.setLayout(null);
			{
				...
				buildLabel.setBounds(142, 55, 36, 15);
			}
			{
			...
			{
				buildActionDisbelieveLabel = new JLabel();
				this.add(buildActionDisbelieveLabel);
				buildActionDisbelieveLabel.setBounds(71, 12, 133, 15);
				buildActionDisbelieveLabel.setName("buildActionDisbelieveLabel");
			}
			{
