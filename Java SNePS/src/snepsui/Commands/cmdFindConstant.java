 ...
 * @author Alia Taher
 */
public class cmdFindConstant extends javax.swing.JPanel {
	...
	public cmdFindConstant(Network network, SNePSInterface frame) {
		super();
...
//			NodeSet resultNodeSet = network.findConstant(array);
