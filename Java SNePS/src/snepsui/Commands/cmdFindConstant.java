...
public class cmdFindConstant extends javax.swing.JPanel {
	private JLabel findConstantLabel;
	...
	private void initGUI() {
		try {
			...
			this.setLayout(null);
			{
				findConstantLabel = new JLabel();
				this.add(findConstantLabel);
				findConstantLabel.setName("findConstantLabel");
				findConstantLabel.setBounds(0, 28, 85, 15);
			}
			{
			...
			}
			{
				...
				jScrollPane2.setBounds(85, 60, 213, 103);
				{
					pathModel = new DefaultListModel();
					pathList = new JList();
					jScrollPane2.setViewportView(pathList);
					pathList.setModel(pathModel);
					pathList.setBounds(37, 175, 228, 100);
					pathList.setPreferredSize(new java.awt.Dimension(197, 83));
				}
			}
			{
