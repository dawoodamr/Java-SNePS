...
*/
public class cmdAndEntailment extends javax.swing.JPanel {
	...
	public cmdAndEntailment(Network network, SNePSInterface frame) {
		super();
		this.frame = frame;
	...
	private void initGUI() {
		try {
			...
			}
			{
				...
				jScrollPane2.setBounds(170, 135, 171, 44);
				{
			...
			}
			{
				...
				nodesetTextField1.setBounds(353, 28, 176, 22);
			}
			{
				nodesetTextField2 = new JTextField();
				this.add(nodesetTextField2);
				nodesetTextField2.setBounds(353, 107, 176, 22);
			}
			{
				jScrollPane3 = new JScrollPane();
				this.add(jScrollPane3);
				jScrollPane3.setBounds(353, 56, 176, 39);
				{
			...
			}
			{
				...
				jScrollPane4.setBounds(353, 134, 176, 45);
				{
			...
			}
			{
				...
				this.add(addButton1);
				addButton1.setBounds(546, 30, 16, 18);
			...
			}
			{
				...
				this.add(addButton2);
				addButton2.setBounds(546, 109, 16, 18);
			...
			}
			{
				...
				buildButton1.setBounds(573, 29, 18, 20);
			...
			}
			{
				...
				buildButton2.setBounds(573, 108, 18, 20);
