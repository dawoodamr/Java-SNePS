		...
		try {
			...
			}
			{
				...
				jScrollPane1.setBounds(80, 58, 440, 103);
				{
					...
					Vector<Object> preconditionData = new Vector<Object>();
					preconditionData.add("precondition");
					preconditionData.add("");
					preconditionData.add("Choose Node Type");
					relationNodesetTableModel.addRow(preconditionData);
				}
			}
			{
