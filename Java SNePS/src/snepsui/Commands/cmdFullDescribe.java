 ...
 * @author Alia Taher
 */
public class cmdFullDescribe extends javax.swing.JPanel {
	private JLabel fullDescribeLabel;
	...
	public cmdFullDescribe(Network network, SNePSInterface frame) {
		super();
		this.frame = frame;
	...
	private void initGUI() {
		try {
			...
			this.setLayout(null);
			{
				fullDescribeLabel = new JLabel();
				this.add(fullDescribeLabel);
				fullDescribeLabel.setName("fullDescribeLabel");
				fullDescribeLabel.setBounds(12, 28, 84, 15);
			}
			{
