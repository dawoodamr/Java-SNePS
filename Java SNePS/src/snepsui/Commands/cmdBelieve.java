...
public class cmdBelieve extends javax.swing.JPanel {
	...
	private JLabel buildActionBelieveLabel;
	...
	public cmdBelieve(Network network) {
		super();
	...
	private void initGUI() {
		try {
			...
			this.setLayout(null);
			{
				...
				buildLabel.setBounds(152, 55, 36, 15);
			}
			{
			...
			{
				buildActionBelieveLabel = new JLabel();
				this.add(buildActionBelieveLabel);
				buildActionBelieveLabel.setBounds(71, 12, 133, 15);
				buildActionBelieveLabel.setName("buildActionBelieveLabel");
			}
			{
